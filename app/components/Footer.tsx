                ...
                <div className="flex flex-col items-center gap-12 lg:gap-6">
                    ...
                    <div className="flex flex-row items-center justify-center gap-4">
                        <a href="https://github.com/rishavroy97" target="_blank" rel="noopener noreferrer" title="Github">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" fill="currentColor" stroke="currentColor" className="w-8 h-8 mx-1 text-lg opacity-75 hover:opacity-100" role="button">
                        ...
                        <a href="https://www.linkedin.com/in/rishavroy97" target="_blank" rel="noopener noreferrer" title="LinkedIn">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="currentColor" stroke="currentColor" className="w-8 h-8 mx-1 text-lg opacity-75 hover:opacity-100" role="button">
                        ...
                        <a href="mailto:rr4577@nyu.edu" target="_blank" rel="noopener noreferrer" title="email">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" stroke="currentColor" className="w-8 h-8 mx-1 text-lg opacity-75 hover:opacity-100" role="button">
