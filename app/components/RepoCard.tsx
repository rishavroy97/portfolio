        ...
        <div className="card w-96 bg-base-100 shadow-xl dark:bg-primary dark:text-base-100 dark:shadow-neutral-500 dark:shadow-md">
            ...
            <div className="card-body flex flex-col gap-4">
                ...
                <div className="card-actions justify-end">
                    <a className="btn btn-circle btn-ghost" href={repo.url} target="_blank" rel="noopener noreferrer">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" fill="currentColor" stroke="currentColor" className="w-8 h-8 dark:hover:text-base-300 mx-1 text-lg" role="button">
